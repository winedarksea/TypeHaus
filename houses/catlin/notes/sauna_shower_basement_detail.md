...
- **THE ROOM ROTATED ON 2026-09-05 AND THE CORNER FOLLOWED IT.** The sauna's long axis is east-west now, against the sunken garden's own wall — a 12'-1 15/16" × 8'-1 11/16" clear box between liner faces (west 5'-3 13/16", east 17'-5 3/4", north 9'-1 3/16", south 0'-11 1/2" west of x=8'-10" and 0'-9 1/2" east of it, a 2" jog the joiner furs flush). The 12'×8' this note is written to is unchanged, and so is everything below about how the wet end is built; what moved is where it is. **The pan is in the room's NORTH-EAST corner**, its two closed sides on the north liner (y=9'-1 3/16") and the east liner (x=17'-5 3/4"), and the floor drain is on the pan's own centre line at (13'-6", 7'-7 3/16"). Read every station below as relocated; the geometry between them is the same.
...
- **Curbed pan plus a floor drain, not one curbless recess.** The 4' shower end is two things: a 36"×36" *curbed* shower pan in the north-east corner (`FX-B-SAUNA-SH`, its two closed sides on the north liner at y=9'-1 3/16" and the east liner at x=17'-5 3/4"), and a floor drain at (13'-6", 7'-7 3/16") (`FX-B-SAUNA-FD`) taking the rest of the wet floor, on the pan's own centre line, 5 1/2" clear west of the curb; `PR-B-SAUNA-DRAIN`, both condensate air gaps and `SP-B-SAUNA-FD` sit with it. The three bullets below are superseded where they conflict; the wall, glass, electrical, lighting and ventilation notes still stand.
...
- Sauna floor: slopes 1/8" per foot down toward the floor drain at (13'-6", 7'-7 3/16") — about 8'-6" of run from the room's far south-west corner, so ~1 1/8" total. Detail shown as sloped slab schematically. The wet floor outside the pan slopes to the same drain, so there is one low point in the room and no dam between the two zones.
