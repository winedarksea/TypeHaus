...
- **Curbed pan plus a floor drain, not one curbless recess.** The 4' shower end is two things: a 36"×36" *curbed* shower pan in the north-east corner (`FX-B-SAUNA-SH`, its two closed sides on the north liner at y=13'-6 3/16" and the east liner at x=17'-2 1/2"), and a floor drain at (13'-6", 12'-0 3/16") (`FX-B-SAUNA-FD`) taking the rest of the wet floor, on the pan's own centre line, 5 1/2" clear west of the curb; `PR-B-SAUNA-DRAIN`, both condensate air gaps and `SP-B-SAUNA-FD` sit with it. The three bullets below are superseded where they conflict; the wall, glass, electrical, lighting and ventilation notes still stand.
