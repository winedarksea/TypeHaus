...
- **No second niche** in the hall bath (`RM-S-BATH1`), which has a shower and no niche
  authored at all. If one is wanted later it is this same type, a second `LightRun`, and a
  share of the same driver.
