...
GARAGE_ROOF_WIND_CLAMPS = [
    ...
    Connector(uid="CM84J5D2KA", tag="CN-G-WIND-RFNW-3", kind=ConnectorKind.STANDING_SEAM_CLAMP,
              position=pt(ft(2), ft(65, 10.375)), elevation=ft(7, 11.44),
              connects=("RF-GARAGE",), size="S-5-N"),
]
