...
#
# **Grade sits 2'-6" below the main floor (2026-08-18).** The model's vertical datum is the
# main floor, so "the house comes 2'-6" out of the ground" is authored the way a drawing set
# states it: FFE stays 0'-0" and grade drops to -2'-6". The house, the sunken garden, the
...
# -2'-6" at the street/north side and around the house, the sunken-garden floor still at
# -9', and the raised-garden apron now standing its full 3'-0" proud of the soil.
...
SITE = Site(
    ...
    # slightly below the -2'-6" grade plane right at the wall and keeps falling. Distinct
    # y-stations also feed every elevation's 10'-deep grade-capture band.
    #
    # The nine house-perimeter stations dropped 2'-6" with grade on 2026-08-18; their
    ...
    spot_elevations=(
        ...
        SpotElevation(position=pt(ft(12), ft(-2)), elevation=ft(-2, -8)),
        SpotElevation(position=pt(ft(26), ft(-3)), elevation=ft(-2, -9)),
        SpotElevation(position=pt(ft(18), ft(-9)), elevation=ft(-3)),
        ...
        SpotElevation(position=pt(ft(30), ft(39)), elevation=ft(-2, -8)),
        SpotElevation(position=pt(ft(32), ft(45)), elevation=ft(-3)),
        # east side (house wall at x=36')
        SpotElevation(position=pt(ft(39), ft(12)), elevation=ft(-2, -8)),
        SpotElevation(position=pt(ft(45), ft(26)), elevation=ft(-3)),
        # west side (house wall at x=0)
        SpotElevation(position=pt(ft(-3), ft(14)), elevation=ft(-2, -8)),
        SpotElevation(position=pt(ft(-9), ft(28)), elevation=ft(-3)),
        ...
        # -9.5') and stay there.
        #
        # None of these four moved when grade dropped to -2'-6": they are the tops of
        # structures, not readings of the soil plane, and those structures stayed put. The
        # +0'-6" pair now stands 3'-0" above grade rather than 6" above it — which is the
        # whole point of the lift, and exactly the apron's own height.
    ...
    # plane, which is 2'-6" under the main-floor datum since 2026-08-18); far_elevation is the
    ...
    impervious_surfaces=(
        ...
        ImperviousSurface(
            ...
            near_elevation=ft(-2, -7),  # -1" below grade at the foundation
            far_elevation=ft(-2, -9),    # -3" at the 4' outer edge (4.2% away)
        ),
        ...
        ImperviousSurface(
            ...
            near_elevation=ft(-2, -7),  # -1" below grade at the foundation
            far_elevation=ft(-2, -10),  # -4" below grade at the 6' outer edge (4.2% away)
        ),
    ),
