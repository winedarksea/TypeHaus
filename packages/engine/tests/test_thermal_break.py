...
#     (123" -> 107", 432" of wall x 16" x 8 psf = −384 lb; §12, 2026-09-23);
...
_PATH = {
    ...
    "house global sliding": (1.5, 4.4447, 0.3375),
...
# T = 227.84 x 184.66 = 42,074.2 lb. Global: 121,409.8 / 42,074.2 = 2.8856 (D 375,410, above).
_PATH_8 = {
    ...
    "house global sliding": (1.5, 2.8856, 0.5198),
    "house far-wall soil bearing": (52_213.6, 130_534.1, 0.4000),
