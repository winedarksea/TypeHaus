# Framing — Catlin House

**House:** Catlin House  
**Trade:** Framing  
**Engine:** 0.1.1  
**Model hash:** 1004c829aed260e5  
**Lines:** 133
...
> **Note**
>
> Quantities are net of waste unless a line says otherwise; this is a request for quote, not a purchase order. Price the scope as you would install it and note where your count differs.

## Lumber and engineered wood, by size
...
| 11.875 I-joist — blocking, joist, sister joist (11.875 I-joist) | 2,388 | LF ordered | 211 pcs, 2140.4 LF cut | building |
...
| 2x4 — blocking, corner stud, cripple stud, header, jack stud, king stud, outlooker, partition backer, plate, raked top plate, stud (2x4) | 4,974 | LF ordered | 679 pcs, 4186.0 LF cut | building |
...
| 2x6 — barge rafter, blocking, corner stud, cripple stud, jack stud, king stud, landing framing, plate, raked top plate, sill, stud (2x6) | 8,630 | LF ordered | 1307 pcs, 7519.2 LF cut | building |
...
## Connectors and fasteners, by part
...
| item | quantity | unit | detail | storeys |
|---|---|---|---|---|
| Treated sill plate, KDAT southern yellow pine (treated exterior framing) (pt-sill-plate) | 402.7 | LF |  | building |
...
| Structural 1 plywood sheathing, 1/2" — wall (struct-1-plywood:0.5) | 3,262.6 | SF net |  | building |
...
| rough opening, 9" x 9" (no type) (None) | 2 | ea | 9" x 9" | main, second |
...
| item | elements |
|---|---|
| 1.25x11.875 rim — rim board (1.25x11.875 rim) | — |
| 1.25x7.25 rim — rim board (1.25x7.25 rim) | — |
| 1.25x7.25 rim White-painted PT lumber — rim board (1.25x7.25 rim:post-paint-white) | — |
| 1.5x11.25 SPF framing lumber — blocking (1.5x11.25:spf) | — |
| 1.75x11.875 LSL — rim board (1.75x11.875 LSL) | — |
| 1.75x11.875 LVL — trimmer (1.75x11.875 LVL) | — |
| 11.875 I-joist — blocking, joist, sister joist (11.875 I-joist) | — |
...
| 2-2x6 — header (2-2x6) | — |
| 2-2x8 — header (2-2x8) | — |
| 24 gable roof truss — roof truss (24 gable roof truss) | — |
| 24 roof truss — roof truss (24 roof truss) | — |
| 25 ga. resilient channel 1/2" resilient channel — girt strapping (25 ga. resilient channel:resilient-channel) | — |
| 2x10 — hanger board (2x10) | — |
| 2x10 SPF framing lumber — blocking (2x10:spf) | — |
...
| Beam — BEAM_WHITE_PAINT (beam:BEAM_WHITE_PAINT) | BM-SG-FRE, BM-SG-FRW |
