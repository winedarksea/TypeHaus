"""Plan-space geometry shared by every glTF builder — no buffers, materials or nodes here.

Pure math over plan rings (SI meters, x east / y north / z up): the single axis conversion into
glTF's Y-up frame, ring hygiene, arch-soffit tessellation, and the thin-rectangle slicing a wall
layer is carved into around its openings.
"""
