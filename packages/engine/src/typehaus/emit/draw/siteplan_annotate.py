...
def _survey_notes(site: Site) -> list[str]:
    ...
    if basis == "survey":
        ...
        first = ("LOT DIMENSIONS SHOWN ARE PLAT / RECORD DIMENSIONS — NOT A SURVEY. NO "
                 "CORNER HAS BEEN LOCATED IN THE FIELD, AND BEARINGS, SETBACK DIMENSIONS "
                 "AND COVERAGE ARE COMPUTED FROM THEM. A CERTIFIED SURVEY BY A LICENSED "
                 "LAND SURVEYOR IS THE DOCUMENT OF RECORD AND GOVERNS OVER THIS SHEET.")
    else:
