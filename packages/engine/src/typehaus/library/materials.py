...
ALL_MATERIALS: tuple[Material, ...] = (
    ...
    Material(tag="eps-deck-form", name="BuildDeck EPS deck form", r_per_inch=2.9,
             ...
             source="BuildDeck installed-section R-values; EPS permeance from ASHRAE/UAF bead-EPS range."),
    Material(tag="rootzone-sand", name="USGA rootzone sand", density=1600.0, hatch="earth", color="#8b7a5e",
             source="USGA Recommendations for a Method of Putting Green Construction, Table 3/4."),
    Material(tag="usga-choker-sand", name="USGA intermediate (choker) sand", density=1600.0,
             hatch="earth", color="#b3a382", source="USGA putting-green construction, Table 2 intermediate layer."),
    Material(tag="usga-bridging-gravel", name="USGA bridging gravel", density=1600.0,
             hatch="gravel", color="#a09a90", source="USGA putting-green construction, Table 2 gravel gradation."),
    Material(tag="geotextile-separation", name="Non-woven geotextile separation fabric",
             perm_rating=100.0, hatch="membrane", color="#9a9a8c", source="AASHTO M288 Class 2 non-woven geotextile."),
    Material(tag="kbg-sod", name="Kentucky bluegrass sod, washed or sand-grown", density=1000.0,
             hatch="earth", color="#5f7a4a", finish="planted", source="USGA sod requirement for sand-rootzone construction; UMN turf guidance."),
    ...
    Material(tag="roof-vent-mat", name="Ventilated underlayment mat (nylon matrix)",
             ...
             source="Open nylon-matrix ventilation mat; air permeance per ASHRAE/UAF still-air reference."),
    Material(tag="roof-adhered-butyl-ht", name="High-temp self-adhered butyl roof membrane",
             r_per_inch=0.0, vapor_permeance_perms=0.05, hatch="membrane", color="#2f3134",
             source="High-temperature self-adhered butyl underlayment technical data, ASTM E96 and ASTM D1970."),
    Material(tag="df-select-s4s", name="Douglas fir Select Structural S4S, eased corners",
             r_per_inch=1.00, density=530.0, perm_rating=2.9, hatch="lumber", color="#d9b077",
             finish="clear-satin-hardwax-oil", source="Douglas-fir lumber thermal/permeance reference values."),
    Material(tag="cabinet-plywood", name="Cabinet-grade hardwood plywood (3/4in)",
             r_per_inch=1.25, density=610.0, perm_rating=0.30, hatch="lumber", color="#c8a97a",
             finish="clear-satin-hardwax-oil", source="Hardwood plywood catalog properties; permeance per APA plywood data."),
    Material(tag="cdx-plywood", name="5/8in CDX sheathing plywood", r_per_inch=1.25,
             density=600.0, perm_rating=0.30, hatch="osb", color="#c9a86a",
             source="APA Rated Sheathing CDX properties and published plywood permeance data."),
    Material(tag="siding-303-mdo", name="5/8in APA Rated Siding 303, MDO smooth face (Exterior)",
             r_per_inch=1.25, density=600.0, perm_rating=0.30, hatch="osb", color="#b9a583",
             source="APA Rated Siding 303 exterior MDO product data; SDPWS Table 4.3B."),
    Material(tag="plywood-underlayment-sanded", name="23/32in sanded-face underlayment plywood, T&G",
             r_per_inch=1.25, density=600.0, perm_rating=0.30, hatch="osb", color="#dcc79a",
             source="APA underlayment/subfloor and Sturd-I-Floor published properties."),
    Material(tag="sauna-shiplap", name="Basswood/aspen shiplap sauna liner (5/4)", r_per_inch=1.3,
             perm_rating=20.0, hatch="lumber", color="#e6d4ae", finish="shiplap", species="basswood",
             stock_bf_per_sqft=1.375, nominal_quarters=5, milling_profile="shiplap",
             source="Sauna-liner species and 5/4 shiplap milling specification."),
    Material(tag="pet-felt-panel", name="PET acoustic felt panel, 1/2in", r_per_inch=3.5,
             density=200.0, perm_rating=10.0, hatch="insulation", color="#6f7a72", finish="felted",
    ...
    Material(tag="fiberglass-r19", name="Fiberglass batt, R-19 (6-1/4in)", r_per_inch=3.04,
             perm_rating=116.0, hatch="batt", color="#f3c6d0", source="R-19 fiberglass batt published loft and R-value."),
    Material(tag="fiberglass-r30c", name="Fiberglass cathedral batt, R-30C compressed to 6-7/8in",
    ...
    Material(tag="roof-underlayment-synthetic", name="Vapour-permeable synthetic roof underlayment",
    ...
    Material(tag="brick", name="Face brick", r_per_inch=0.20, density=1920.0, perm_rating=1.0,
             hatch="concrete", color="#9c5a4a", finish="brick", source="Face-brick thermal and vapour reference values."),
    Material(tag="foundation-coating-acrylic", name="Trowel-applied acrylic foundation coating over mesh (1/8in)",
             r_per_inch=0.0, density=1400.0, vapor_permeance_perms=5.0, coating=True,
             hatch="concrete", color="#8e8f8c", source="Acrylic foundation-coating product data and exterior acrylic/stucco vapour references."),
    Material(tag="foundation-protection-panel", name="Aluminium-faced foundation protection panel (1/2in)",
             r_per_inch=0.0, density=1100.0, hatch="metal", color="#1c1f24",
             source="Aluminium-faced foundation-protection panel product class; no installed ASTM E96 value published."),
)
