...
MN_2020 = JurisdictionProfile(
    ...
    coverage_statement=(
        ...
        "Added 2026-09-17: notching and boring limits — R502.8.1 joists "
        "(mep.run_member_crossing), R602.6 studs (mep.run_through_stud) and R602.6.1 top "
        "plates (mep.run_through_plate), all graded against the ACTUAL resolved members "
        "rather than against a spacing, so a staggered wall is graded on the studs it has. "
    ...
    permit_items=(
        ...
        PermitItemSpec("Exterior wall covering — wind pressure",
                       ("structural.cladding_wind", "structural.cladding_fastener"),
                       ("IRC R703.1.2", "ASCE 7-16 §30.3")),
