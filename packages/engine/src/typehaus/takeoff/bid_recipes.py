...
SHAPES: dict[str, Shape] = {
    ...
    "concrete": Shape("Pours and solids, by the yard", _solid, "cy"),
    "reinforcement": Shape("Reinforcing steel, by bar", _bar, "lb"),
    "wall_structure": Shape("Wall structure, by the yard", None, "cy"),
    ...
    "solar_modules": Shape("PV modules", None, "W"),
    ...
    "timber": Shape("Timber, by the yard", _solid, "cy"),
