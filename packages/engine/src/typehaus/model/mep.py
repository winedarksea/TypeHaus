...
class Equipment(Element):
    ...
    # --- UPC 608.5 (Minn. R. 4714.0608): temperature and pressure relief, water heaters ----
    ...
    # UPC 507.5: a pan under a heater installed where a leak damages what is below it, and
