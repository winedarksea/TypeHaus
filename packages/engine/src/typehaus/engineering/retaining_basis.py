...
Split out of ``retaining_wall.py`` on 2026-08-30 and, in that commit, **a pure move with no
behaviour change**. It exists because two modules need the same arithmetic and one of them
...
def stem_flexure(geometry: _Geometry, case: _Case,
    ...
    **This is the limit state nothing in this engine computed until 2026-08-30, and on the
