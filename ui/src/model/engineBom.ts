...
export const SECTION_GROUPS: readonly BomSectionGroup[] = [
  {
    ...
    title: "Structure",
    sections: ["framing", "framing_by_size", "structural_solids", "sheet_goods",
  ...
  },
  {
    ...
    sections: ["envelope_layers", "glazing_panels", "glazing_trim", "bug_screens",
      "openings", "floor_finishes", "stair_finish", "railings"],
  },
  {
    id: "mep",
    note: "Pipe, duct, cast-in sleeves, radiant floor element and the storm run.",
    title: "Mechanical & plumbing",
    sections: ["pipe_runs", "ducts", "sleeves", "floor_heat", "drainage"],
  },
  {
    id: "electrical",
