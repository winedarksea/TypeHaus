...
// band is the line down the guard, so an open well edge and a guarded one read differently.
// The infill is filtered out upstream in useStoreySlice, where the reasoning lives.
//
