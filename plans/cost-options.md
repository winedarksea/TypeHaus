...
| ⚠ **Shorten the sunken court further, 26' → 23'-11" N–S** | **$1,450–2,700** | arithmetic, 2026-09-10 | no | garden-footing engineering; the boom pump | **2'-1" is ALL that is left. There is a hard structural floor at 23'-11", and it MOVED UP when the strips narrowed (23'-3" at 8'-0") — the two cuts are not independent. Re-derive it, never quote it.** Shortening removes base friction from the capacity and NOTHING from the demand — the E–W thrusts cancel identically, so the resultant is the south wall's thrust over the court's WIDTH, which does not change. At 23'-11" the system reaches the 1.50 IRC R404.4 minimum and stops. This row read "28' → 16' for $9,700–16,600" until 2026-09-10; **that was never available** — 16' fails sliding in all four soil corners. The first 2'-0" has been taken (see below) |
