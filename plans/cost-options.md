...
| **Rebar, ~5 tons** | $10,000–18,000 | Deliberately inside the `[concrete]` $/cy rates and documented at both ends. **If it is ever authored as real elements, cut those rates the same day** — nothing enforces that. Logged in `plans/TODO.md` |
